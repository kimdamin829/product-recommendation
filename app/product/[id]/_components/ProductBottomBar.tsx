      ...
      <div className="w-full flex justify-center">
        <div className={`w-full bg-white shadow-lg ${staticPosition ? 'border border-gray-200 rounded-lg' : 'max-w-[480px] border-t border-gray-200'}`}>
          ...
          <div className="px-0 pt-0 pb-0 flex gap-0">
            ...
            >
              {isWished ? (
                <svg className="w-6 h-6 text-green-1000" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              onClick={onCartClick}
              className="bg-green-800 text-white py-3 text-base font-semibold hover:bg-green-800"
              style={{ width: '50%' }}
            >
              장바구니
            </button>
